...
exports["default"] = expandAliasedAction;
...
function expandAliasedAction(action) {
  (0, _assert["default"])(action.meta && action.meta.trigger, 'No trigger defined');

  var alias = _alias["default"].get(action.meta.trigger);

  (0, _assert["default"])(alias, "Trigger alias ".concat(action.meta.trigger, " not found"));
  return alias.apply(void 0, _toConsumableArray(action.payload || []));
}